...
export const initialTheme: any = {
	default: {
		...
		surfaceContainer: { light: '#e7e7e7', dark: '#343434' },
		surfaceOnContainer: { light: '#212121', dark: '#ffffff' },
		surfaceContainerDisabled: { light: '#d9dadc', dark: '#20272e' },
		surfaceOnContainerDisabled: { light: '#b7b9bc', dark: '#3e464e' },
